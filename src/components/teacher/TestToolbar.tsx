      ...
      <div className="flex items-center gap-2 p-4">
        ...
        <button
          ...
          className={`p-2.5 rounded-lg transition-colors group ${
            activeFormats?.bold ? 'bg-blue-500/20 hover:bg-blue-500/30' : 'hover:bg-[var(--bg-hover)]'
          }`}
          data-tooltip={t('tooltips.bold')}
        >
          <svg width="16" height="16" viewBox="0 0 384 512" className={`transition-colors ${
            activeFormats?.bold ? 'text-blue-400' : 'text-[var(--text-tertiary)] group-hover:text-[var(--text-primary)]'
          }`}>
        ...
        <button
          ...
          className={`p-2.5 rounded-lg transition-colors group ${
            activeFormats?.italic ? 'bg-blue-500/20 hover:bg-blue-500/30' : 'hover:bg-[var(--bg-hover)]'
          }`}
          data-tooltip={t('tooltips.italic')}
        >
          <svg width="16" height="16" viewBox="0 0 320 512" className={`transition-colors ${
            activeFormats?.italic ? 'text-blue-400' : 'text-[var(--text-tertiary)] group-hover:text-[var(--text-primary)]'
          }`}>
        ...
        <button
          ...
          className={`p-2.5 rounded-lg transition-colors group ${
            activeFormats?.strikethrough ? 'bg-blue-500/20 hover:bg-blue-500/30' : 'hover:bg-[var(--bg-hover)]'
          }`}
          data-tooltip={t('tooltips.strikethrough')}
        >
          <svg width="16" height="16" viewBox="0 0 512 512" className={`transition-colors ${
            activeFormats?.strikethrough ? 'text-blue-400' : 'text-[var(--text-tertiary)] group-hover:text-[var(--text-primary)]'
          }`}>
        ...
        <button
          ...
          className={`p-2.5 rounded-lg transition-colors group ${
            activeFormats?.underline ? 'bg-blue-500/20 hover:bg-blue-500/30' : 'hover:bg-[var(--bg-hover)]'
          }`}
          data-tooltip={t('tooltips.underline')}
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className={`transition-colors ${
            activeFormats?.underline ? 'text-blue-400' : 'text-[var(--text-tertiary)] group-hover:text-[var(--text-primary)]'
        ...
        <button
          ...
          className={`p-2.5 rounded-lg transition-colors group ${
            isPreviewMode ? 'bg-blue-500/20' : 'hover:bg-[var(--bg-hover)]'
          }`}
